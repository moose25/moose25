<!--
  Profile README for @moose25. EDIT-ME markers show where to add your own bits.
  Cards use the Tokyo Night theme.
-->
...
<!-- EDIT-ME: tweak your stack — full list at https://skillicons.dev -->
<img src="https://skillicons.dev/icons?i=py,aws,bash,ts,kotlin,git,linux,vscode" alt="tech" />
...
<img src="https://github-readme-activity-graph.vercel.app/graph?username=moose25&theme=tokyo-night&hide_border=true&area=true" alt="activity graph" />

</div>

<!--
  EDIT-ME — other widgets you could add later (some need setup):
  • Spotify "now playing" — https://github.com/kittinan/spotify-github-profile
  • WakaTime coding stats  — needs a WakaTime account
  • Contribution snake     — https://github.com/Platane/snk  (runs as a GitHub Action)
-->
